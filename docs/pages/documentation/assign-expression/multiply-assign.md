...
You can build an expression tree which contains an multiplication assignment operation using `Expression.MultiplyAssign` method. For example, you have the following code.
